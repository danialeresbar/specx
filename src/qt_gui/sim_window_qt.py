...
"}")
        ...
        self.channel_field_1.addWidget(self.chart_test_1)
        ...
        self.channel_field_2.addWidget(self.chart_test_2)
        ...
        self.channel_field_3.addWidget(self.chart_test_3)
        ...
        self.channel_field_4.addWidget(self.chart_test_4)
        ...
        self.channel_field_5.addWidget(self.chart_test_5)
        ...
        self.channel_field_6.addWidget(self.chart_test_6)
        ...
        self.channel_field_7.addWidget(self.chart_test_7)
        ...
        self.channel_field_8.addWidget(self.chart_test_8)
        ...
        self.channel_field_9.addWidget(self.chart_test_9)
        ...
        self.chart_bars.setRenderHint(QtGui.QPainter.Antialiasing)
        self.chart_layout.addWidget(self.chart_bars)
        self.main_layout.addLayout(self.chart_layout)
        self.main_layout.setStretch(0, 5)
        self.main_layout.setStretch(1, 70)
        self.main_layout.setStretch(2, 25)
