...
class Ui_config_dialog(object):
    def setupUi(self, config_dialog):
        ...
        sizePolicy.setHeightForWidth(
            config_dialog.sizePolicy().hasHeightForWidth()
        )
...
"}")
        ...
        self.chart_preview_box.setFont(font)
        self.chart_preview_box.setObjectName("chart_preview_box")
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.parameter_spbox_1.setFont(font)
        self.parameter_spbox_1.setDecimals(10)
        self.parameter_spbox_1.setSingleStep(0.1)
        self.parameter_spbox_1.setObjectName("parameter_spbox_1")
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.parameter_spbox_2.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.parameter_spbox_3.setFont(font)
        ...
        self.parameter_spbox_4.setFont(font)
        self.parameter_spbox_4.setDecimals(10)
        self.parameter_spbox_4.setObjectName("parameter_spbox_4")
    ...
    def retranslateUi(self, config_dialog):
        ...
        self.chart_preview_box.setTitle(_translate("config_dialog", "Vista preliminar"))
        self.parameters_box.setTitle(_translate("config_dialog", "Parámetros"))
        self.radiobtn_1.setText(_translate("config_dialog", c.ONE_PARAMETER))
        self.radiobtn_2.setText(_translate("config_dialog", c.TWO_PARAMETERS))
        self.radiobtn_3.setText(_translate("config_dialog", c.THREE_PARAMETERS))
        self.parameter_label_1.setText(_translate("config_dialog", c.FIRST_PARAMETER))
        self.parameter_label_2.setText(_translate("config_dialog", c.SECOND_PARAMETER))
        self.parameter_label_3.setText(_translate("config_dialog", c.THIRD_PARAMETER))
        self.parameter_label_4.setText(_translate("config_dialog", c.FOURTH_PARAMETER))
