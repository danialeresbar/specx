...
"	color: #787878;\n"
	...
	"    color: #787878;\n"
        ...
        "}")
                ...
                self.pdf_1.addItem("")
                self.pdf_1.addItem("")
                self.pdf_1.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_2.addItem("")
                self.pdf_2.addItem("")
                self.pdf_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_3.addItem("")
                self.pdf_3.addItem("")
                self.pdf_3.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_4.addItem("")
                self.pdf_4.addItem("")
                self.pdf_4.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_5.addItem("")
                self.pdf_5.addItem("")
                self.pdf_5.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_6.addItem("")
                self.pdf_6.addItem("")
                self.pdf_6.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_7.addItem("")
                self.pdf_7.addItem("")
                self.pdf_7.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_8.addItem("")
                self.pdf_8.addItem("")
                self.pdf_8.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
                ...
                self.pdf_9.addItem("")
                self.pdf_9.addItem("")
                self.pdf_9.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        def retranslateUi(self, main_window):
                ...
                self.save_file_button.setText(_translate("main_window", "Guardar"))
                self.load_file_button.setText(_translate("main_window", "Cargar"))
