...
"}")
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.box_params.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.btn_simulator.sizePolicy().hasHeightForWidth())
        self.btn_simulator.setSizePolicy(sizePolicy)
        self.btn_simulator.setCursor(
...
"}")
        ...
        self.btn_simulator.setObjectName("btn_simulator")
...
"}")
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.box_freq.sizePolicy().hasHeightForWidth())
        ...
        self.field_1.addWidget(self.label_channel_1)
        ...
        self.boxes = [self.box_1, self.box_2, self.box_3,
                        self.box_4, self.box_5, self.box_6,
                        self.box_7, self.box_8, self.box_9]
        ...
        for box in self.boxes:
            ...
            box.setPlaceholderText('Elije una distribución')
            box.addItem("")
            box.addItem("")
            box.addItem("")
            box.addItem("")
        ...
        self.field_1.addWidget(self.box_1)
        ...
        self.field_2.addWidget(self.label_channel_2)
        self.field_2.addWidget(self.box_2)
        ...
        self.field_3.addWidget(self.label_channel_3)
        self.field_3.addWidget(self.box_3)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_channel_4.setFont(font)
        self.label_channel_4.setObjectName("label_channel_4")
        self.field_4.addWidget(self.label_channel_4)
        self.field_4.addWidget(self.box_4)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_channel_5.setFont(font)
        self.label_channel_5.setObjectName("label_channel_5")
        self.field_5.addWidget(self.label_channel_5)
        self.field_5.addWidget(self.box_5)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_channel_6.setFont(font)
        self.label_channel_6.setObjectName("label_channel_6")
        self.field_6.addWidget(self.label_channel_6)
        self.field_6.addWidget(self.box_6)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_channel_7.setFont(font)
        self.label_channel_7.setObjectName("label_channel_7")
        self.field_7.addWidget(self.label_channel_7)
        self.field_7.addWidget(self.box_7)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_channel_8.setFont(font)
        self.label_channel_8.setObjectName("label_channel_8")
        self.field_8.addWidget(self.label_channel_8)
        self.field_8.addWidget(self.box_8)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_channel_9.setFont(font)
        self.label_channel_9.setObjectName("label_channel_9")
        self.field_9.addWidget(self.label_channel_9)
        self.field_9.addWidget(self.box_9)
        ...
        self.btn_save_file = QtWidgets.QPushButton(
            self.box_freq)
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, main_window):
        ...
        self.btn_save_file.setText(_translate("main_window", "Guardar"))
        self.btn_load_file.setText(_translate("main_window", "Cargar"))
